pipeline {
    ...
    environment {
        DOCKERHUB_USERNAME = 'sindhu2002'
        DOCKER_IMAGE = "${DOCKERHUB_USERNAME}/canara_sindhu"
    ...
    parameters {
        ...
        string(name: 'RECEIVER_EMAIL', defaultValue: 'sindhugh6@gmail.com', description: 'Comma-separated recipient emails')
    }
